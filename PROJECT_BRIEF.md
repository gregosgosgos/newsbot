> ⚠️ **이 문서는 초기(72시간 런칭) 계획 기록입니다 — 역사 참고용.**
> 현재 상태·구조·운영법은 **[README.md](README.md)** 와 **[docs/](docs/)** 를 먼저 보세요.
> (아래 내용 중 일부는 이후 결정으로 바뀌었습니다: 배포 방식, 모델 버전, 디자인 등.)

---

# PROJECT BRIEF — 뉴스 인스타 자동화 실험 (초기 계획, 역사 기록)

이 문서는 초기 런칭 당시의 전체 맥락/지침입니다.
현재 이어받아 작업한다면 README.md → docs/ 순으로 보세요.
