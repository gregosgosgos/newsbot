...
if __name__ == "__main__":
    items = [
        {"headline": "알리익스프레스, EU 과징금 9300억", "subtitle": "과징금 9300억",
         ...
         "simple": "가짜·위험한 물건 방치를 이유로 판매자가 아닌 '판을 깔아준' 플랫폼이 직접 벌금을 문 첫 사례급 사건입니다. 지금까지는 문제가 생기면 판매자만 책임졌지만, 이제는 플랫폼도 함께 책임지라는 신호입니다. 앞으로 대형 플랫폼은 상품을 더 깐깐하게 검수해야 하고, 소비자 입장에선 위험 상품에 노출될 가능성이 줄어드는 변화입니다.",
