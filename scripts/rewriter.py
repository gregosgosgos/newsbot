...
- relevance(가장 중요): 위 '독자'가 이 기사를 보고 "내 일과 관련 있다"고 느낄 정도를 0~100으로 매겨라.
  ...
  · 판정 기준은 '기사의 주인공이 누구인가'다. 기업·은행·기관이 자기 실적/전략/행사를 알리는 기사에서
    위 독자가 그저 스쳐 지나가듯 언급될 뿐이라면, 키워드가 맞아도 40점 이하다.
    (예: 은행의 분기 실적 발표 기사에 '소상공인 지원' 문구가 한 줄 들어간 경우 → 30점)
  · 반대로 독자의 비용·매출·규제·거래조건을 실제로 바꾸는 기사는 높게 매겨라.
  · 애매하면 낮은 쪽으로. 이 계정은 관련 없는 뉴스를 싣느니 뉴스 개수가 적은 편이 낫다.
